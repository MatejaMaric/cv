...
\cvevent{Data Engineer}{Holycode (C Wire team)}{April 2022 --- Present}{Belgrade, Serbia}

\begin{itemize}
\item I am currently working at Holycode as a Data Engineer in C Wire team.
\item C Wire is a Swiss-based IT startup working on it's in-house contextual advertising solution.
\item Technologies that I use daily are Go, TypeScript, Kubernetes, Docker, Apache Kafka, Redis and AWS.
\end{itemize}
...
\begin{itemize}
\item I worked as a JavaScript Developer at Computer Rock, a Swiss-based IT agency.
      I was mostly working with Vue.js, Nuxt.js and SCSS.
...
\item I also worked on the Web UI of a British client's real estate data extraction
      and analysis tool.
\end{itemize}
